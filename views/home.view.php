          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              ...
              <ul class="my-4 bg-gray-100 p-4 rounded">
                <li class="mb-2"><strong>Writer:</strong> John Doe</li>
                <li class="mb-2">
              ...
              <a href="details.html"
                class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium text-slate-200 bg-slate-900 hover:bg-indigo-200"
              >
                Details
              </a>
            </div>
